     ...
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
            ...
            <ul>
              ...
              <li><span class="scenario-objective">Create tables to support querying for videos by actor or genre</span></li>
              <li><span class="scenario-objective">Load data into the tables from CSV files</span></li>
            </ul>
      </div>
     </div>
    </div>
